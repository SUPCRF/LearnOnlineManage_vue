...
export default class Index extends Vue {
  ...
  getInfo() {
    ...
    axios({
      url: "http://localhost:8000/api/teacher-user/all",
      method: "get",
  ...
  add() {
    ...
    axios({
      url: "http://localhost:8000/api/teacher-user/save",
      method: "post",
      data: formdata,
      headers: { Authorization: token },
    }).then((res) => {
  ...
  modifyUser() {
    ...
    axios({
      url: "http://localhost:8000/api/teacher-user/modif",
      method: "post",
      data: formdata,
      headers: { Authorization: token },
    })
  ...
  handleStart(index, row) {
    this.$confirm("是否启用？", "确定启用", {
      ...
      .then(() => {
        ...
        console.log(formdata);
        axios({
          url: "http://localhost:8000/api/teacher-user/start",
          method: "post",
          data: formdata,
          headers: { Authorization: token },
        })
  ...
  handleDelete(index, row) {
    this.$confirm("是否停用？", "确定停用", {
      ...
      .then(() => {
        ...
        console.log(formdata);
        axios({
          url: "http://localhost:8000/api/teacher-user/delete",
          method: "post",
          data: formdata,
          headers: { Authorization: token },
        })
